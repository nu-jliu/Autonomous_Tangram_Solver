...
static const _TangramPoses_type_support_symbol_names_t _TangramPoses_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tangram_msgs, msg, TangramPoses)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tangram_msgs, msg, TangramPoses)),
  }
};
...
{
  return &::tangram_msgs::msg::rosidl_typesupport_cpp::TangramPoses_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tangram_msgs, msg, TangramPoses)() {
  return get_message_type_support_handle<tangram_msgs::msg::TangramPoses>();
}
