...
#include "tangram_msgs/msg/detail/tangram_pose__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tangram_msgs::msg::TangramPose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tangram_msgs::msg::TangramPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tangram_msgs::msg::TangramPose *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TangramPose__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tangram_msgs::msg::TangramPose *>(
...
static size_t _TangramPose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TangramPose(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TangramPose__callbacks = {
  "tangram_msgs::msg",
  "TangramPose",
...
static rosidl_message_type_support_t _TangramPose__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TangramPose__callbacks,
...
{
  return &tangram_msgs::msg::typesupport_fastrtps_cpp::_TangramPose__handle;
}
