...
static const _TangramPose_type_support_symbol_names_t _TangramPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tangram_msgs, msg, TangramPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tangram_msgs, msg, TangramPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tangram_msgs, msg, TangramPose)() {
  return &::tangram_msgs::msg::rosidl_typesupport_c::TangramPose_message_type_support_handle;
}
