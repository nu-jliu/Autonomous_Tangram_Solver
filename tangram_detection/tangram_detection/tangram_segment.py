...
class TangramSegment(Node):
    ...
    def __init__(self) -> None:
        ...
        self.pub_image_segment = self.create_publisher(
            Image,
            "tangram/image/segment",
            10,
        )
    ...
    def timer_callback(self):
        ...
        if self.input_tensor is not None and self.input_ready:
            ...
            image_msg = self.bridge.cv2_to_imgmsg(segment_array, encoding="mono8")
            self.pub_image_segment.publish(image_msg)
